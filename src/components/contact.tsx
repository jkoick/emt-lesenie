      ...
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16 space-y-4">
            <h2 className="text-4xl md:text-5xl font-bold text-balance">Kontakt</h2>
              ...
              <CardContent className="p-8 space-y-4">
                <div className="flex flex-col items-center text-center gap-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+421904350340" className="text-muted-foreground hover:text-primary transition-colors">
                      +421 904 350 340
                    </a>
                  </div>
                </div>
              ...
              <CardContent className="p-8 space-y-4">
                <div className="flex flex-col items-center text-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">Petrovce nad Laborcom</p>
