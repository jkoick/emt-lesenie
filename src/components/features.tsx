      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Profesionálne lešenie pre vašu stavbu</h2>
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              Lešenie, známe aj ako montovaná dočasná konštrukcia, je neoddeliteľnou súčasťou takmer každého stavebného
              projektu. Jeho hlavnou úlohou je zabezpečiť bezpečný a stabilný prístup k práci vo výškach – či už ide o
              rekonštrukciu, údržbu alebo novostavbu.
            </p>
          </div>
