        ...
        <div className="max-w-4xl mx-auto space-y-12">
          <ScrollReveal className="text-center">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed mb-8">
              ...
              fasádneho lešenia. Ponúkame kvalitné, bezpečné produkty s rýchlou
              dodávkou a férovým prístupom. Za našou prácou stoja desiatky
              spokojných zákazníkov – od stavebných firiem až po súkromné osoby.
            </p>
          </ScrollReveal>
